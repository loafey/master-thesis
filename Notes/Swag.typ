...
// TODO (Sebastian): format better
#grid(
  columns: 1fr,
  row-gutter: 16pt,
  [$(A:n quad B:omega)/(A times.circle B : omega)$], [$(A:n quad B:m)/(A times.circle B : n+m)$],
  [$(A:n)/(tilde.basic A:omega)$],[$(Gamma, x:A tack.r c)/(Gamma tack.r lambda^(tilde.basic) x . c)$],
  [$(Gamma tack.r t:A)/(Gamma, z:tilde.basic A tack.r text("call")^tilde.basic z (t))$],

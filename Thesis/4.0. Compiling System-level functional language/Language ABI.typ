...
As with any system-level language, one should define an application binary interface (ABI), and in turn a calling convention.
...
The following table specifies the memory representation of types in #ln, and
